    ...
    <div>
      ...
      {lead.status === "converted" ? (
        <p className="mt-4 rounded-lg border border-success/30 bg-success/5 p-3 text-sm text-ink">
          ...
          <Link href="/admin/crm/students?status=pending" className="font-semibold text-brand-blue-400 hover:underline">
            Students
          </Link>
          .
        </p>
          ...
          <section className="rounded-xl border bg-card p-5">
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <Button asChild variant="outline" size="sm">
                <Link href={`/admin/crm/leads/${lead.id}/edit`}>Edit</Link>
              </Button>
            </div>
